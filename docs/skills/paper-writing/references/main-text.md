...
- [Award-paper patterns](evidence/award-paper-patterns.md): an earlier broader record; current section guides supersede its historical drafting prescriptions.
