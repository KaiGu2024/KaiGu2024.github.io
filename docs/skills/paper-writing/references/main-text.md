...
The Cochrane structure dominates top-5 empirical economics. Cap at three pages. Eleven paragraphs is a generous upper bound. The structural rules in Movements 2–4 below are backed by an evidence base of recent award-winning papers — verified winners and full-text skeletons across economics, marketing, and IS — in [`award-paper-patterns.md`](award-paper-patterns.md); consult it when you want examples behind a rule.
