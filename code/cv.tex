...
{\small Knowledge platforms increasingly deploy AI tools to accelerate content production, yet the ecosystem-level consequences of these deployment decisions remain poorly understood. We conduct a large-scale audit of AI-assisted content creation on Wikipedia, examining how machine translation (MT) relates to information volume and diversity in multilingual knowledge ecosystems. Using over half a million matched article pairs across ten language editions, we document an efficiency--diversity trade-off: relative to independently written articles, MT-assisted articles deliver substantially greater information volume and content completeness for target-language readers, yet contribute significantly less novel information to the cross-language knowledge ecosystem. MT-assisted articles exhibit lower semantic divergence from their English source articles and lower information breadth across language pairs and topic categories; the missing content is often culturally anchored---local context, regional perspectives, and cultural details that human editors naturally add. To map the trade-off frontier, we simulate ecosystem-level information volume and diversity outcomes across a range of MT adoption ratios, illustrating how aggregate efficiency and diversity co-evolve as platforms shift their deployment strategies. Our findings suggest the need for explicit governance frameworks that acknowledge trade-offs, monitor ecosystem-level outcomes, and design AI deployment strategies that preserve valued properties while capturing efficiency gains.}
