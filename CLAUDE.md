...
# Report folder-skill with optional references
cp docs/skills/report/SKILL.md ~/.claude/skills/report/SKILL.md
cp docs/skills/report/references/*.md ~/.claude/skills/report/references/

# Folder-skill (copy references only when present)
...
- `report/`: structured analysis reports with optional empirical-validity and benchmark references
